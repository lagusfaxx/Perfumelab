...
export const FAMILIAS: Record<FamiliaKey, FamiliaSensorial> = {
  CITRICOS: {
    ...
    colorSoft: '#f6ef9a',
    colorDeep: '#9bbf2e',
    mood: 'Luz que estalla. Chispa, frescor que despierta.',
  ...
  FLORALES: {
    ...
    colorSoft: '#f7d6e6',
    colorDeep: '#b76a91',
    mood: 'Pétalos suspendidos en aire tibio. Delicadeza que respira.',
  ...
  AMADERADOS: {
    ...
    colorSoft: '#c69366',
    colorDeep: '#4a3018',
    mood: 'Grano, resina, calor de tronco. El tiempo hecho aroma.',
  ...
  ORIENTALES: {
    ...
    colorSoft: '#caa9e8',
    colorDeep: '#3c2160',
    mood: 'Penumbra dorada, ámbar y especia. Intimidad envolvente.',
  ...
  ACUATICOS: {
    ...
    colorSoft: '#a9dcf2',
    colorDeep: '#1c5e85',
    mood: 'Brisa salina, ondas, aire abierto. Respiración limpia.',
  ...
  VERDES: {
    ...
    colorSoft: '#aedeb8',
    colorDeep: '#2f6b3c',
    mood: 'Tallo partido, hierba húmeda, savia. Frescor terroso.',
